...
var intro_string = "오랜 시간 머물 수 있는<br />고요한 장소에서 성찰하시기 바랍니다.<br /><br />이 프로그램에 저장기능은 없습니다.<br />이미 답한 항목은 다시 확인할 수 없으며,<br />중간에 페이지를 벗어나면<br />이어서 할 수 없습니다.<br /><br />예상 소요시간은 30분이고<br />성찰을 완료하면 텍스트로 결과를 저장하여<br />고해성사에 참조하세요.";
